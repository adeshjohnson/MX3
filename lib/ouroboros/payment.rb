...
=end
    ...
    def Payment::format_policy(ob_max_amount = nil, retry_count = nil,completion = nil, completion_over = nil)
      policy = []
...
=end
    ...
    def Payment::format_amount(param_amount, min_amount, max_amount) 
