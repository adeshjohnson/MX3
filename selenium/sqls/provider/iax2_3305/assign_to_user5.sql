UPDATE `devices` SET `description` = 'res_prov_iax2', `user_id` = 5, `server_id` = 1, `auth` = 'md5' WHERE `devices`.`id` = 2304;
...
INSERT INTO `server_devices` (`device_id`, `server_id`) VALUES (2304, 16);