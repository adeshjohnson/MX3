class TestController < ApplicationController
  ...
  def load_delta_sql
    ...
    #MorLog.my_debug(File.exist?("#{RAILS_ROOT}/config/routes.rb"))
    filename = "#{RAILS_ROOT}/selenium/tests/#{params[:path].join("/").gsub(/[^A-Za-z_\/]/, "")}.sql"
  ...
  def run_ma_script
    script_path = File.expand_path("#{RAILS_ROOT}/lib/scripts/monitoring_script.rb")
