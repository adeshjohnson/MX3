class LcrsController < ApplicationController
  ...
  before_filter :find_lcr_from_id, :only=>[:make_tariff, :details, :provider_change_status, :remove_provider, :try_to_add_provider, :providers_sort_save, :providers_sort, :providers_percent, :provider_change_status, :edit, :update, :destroy, :details_by_destinations, :providers_list]
  before_filter :find_lcr_partial_from_id, :only=>[:lcrpartial_destroy,:lcrpartial_edit, :update_lcrpartial]
  before_filter :check_owner, :only=>[:make_tariff, :details, :provider_change_status, :remove_provider, :try_to_add_provider, :providers_sort_save, :providers_sort, :providers_percent, :provider_change_status, :edit, :update, :destroy, :details_by_destinations, :providers_list]


  # GETs should be safe (see http://www.w3.org/2001/tag/doc/whenToUseGet.html)
  verify :method => :post, :only => [:remove_provider, :destroy, :create, :update, :lcrpartial_destroy, :update_lcrpartial ],
    :redirect_to => { :action => :list },
    :add_flash => { :notice => _('Dont_be_so_smart')
    #,:params => {:dont_be_so_smart => true}   KRISTINA - sometimes missing translation
  }
