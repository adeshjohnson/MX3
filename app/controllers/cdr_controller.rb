      ...
      for @user in users
        ...
        if @user
          ...
          for call in @calls
            ...
            grace_time = device.grace_time
            if provider and provider.user_id == current_user.get_corrected_owner_id and ((grace_time.blank? ? -1 : grace_time.to_i ) < call.billsec.to_i)
