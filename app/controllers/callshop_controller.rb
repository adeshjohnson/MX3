...
class CallshopController < ApplicationController
  ...
  skip_before_filter :redirect_callshop_manager, :only => [:new, :main, :show, :show_json, :reserve_booth, :free_booth, :release_booth, :invoices, :invoice_edit, :update, :comment_update, :rate_search, :invoice_print] 
