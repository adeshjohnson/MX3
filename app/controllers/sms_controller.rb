class SmsController < ApplicationController
  ...
  verify :method => :post, :only => [ :destroy, :create, :update, :lcr_destroy, :lcr_create, :lcr_update, :provider_update, :provider_create, :provider_destroy, :tariff_create, :tariff_destroy, :tariff_update, :rate_update, :rate_create, :rate_destroy],
...
=end
  ...
  def provider_new
    ...
    @tariffs = SmsTariff.find(:all, :conditions => ["tariff_type = 'provider' AND owner_id = '#{session[:user_id]}'"])
...
=end
  def provider_edit
    ...
    @page_icon = "edit.png"
    @tariffs = SmsTariff.find(:all, :conditions=>"owner_id = '#{session[:user_id]}'")
  end
...
=end
  def provider_update
    @provider.update_attributes(params[:provider].each_value(&:strip!))
...
=end
  def tariffs
    ...
    @prov_tariffs = SmsTariff.find(:all, :conditions => "tariff_type = 'provider' AND owner_id = '#{@user.id}'", :order => "name ASC")
