...
class GatewayEngine
  ...
  field :gateways, :form, :without_tax, { :as => 'plain_text', :position => 110, :html_options => { :size => 20, :disabled => "disabled", :class => "input" }, :after => lambda{|g| " in #{g.settings['default_currency']}" } }
  field :gateways, :form, :with_tax, { :as => 'plain_text', :position => 120, :html_options => { :size => 10, :disabled => "disabled", :class => "input" }, :after => lambda{|g| " in #{g.settings['default_currency']}" } }
