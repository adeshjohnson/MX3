    ...
    $.fn.callshop = function(options, i18ne) {
        ...
        $(this).each(function() {
            ...
            $(this).find("a.cancel").live('click', function(ev) {
                ...
                return false; /* omg this is magic! */
            });
                ...
                if (booth.state != "reservation_form") {
                    ...
                    if (booth.element.id in options.cache.booth_forms) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                callshop.change_state(booth, "reservation_form", {});
                                var form = $(data).css('display', 'none'); /* hide ajax-fetched content at first */
                                ...
                                form.insertAfter($(booth.element)).show(); /* inject content and show it */
                            }
                        });
                    }
            ...
            change_state: function(booth, state, options) {
                ...
                switch(booth.state) {
                    ...
                    case "free":
                        ...
                        row.find('.balance-value').removeClass('postpaid prepaid'); /* balance */
                        row.find('.balance').find('a').remove(); /* balance */
